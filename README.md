...
Centralizar la gestión, publicación y difusión automatizada de información institucional, además de servir como una plataforma de orientación ciudadana para la gestión de trámites. El sistema busca eliminar la fragmentación informativa, reducir la dependencia de métodos manuales y mitigar la desinformación, garantizando transparencia y eficiencia en la comunicación municipal.

2. Actores del Sistema
Administrador (Departamento de Prensa/Informática): Gestiona el contenido web, mantiene actualizada la base de datos de requisitos y supervisa la vinculación con redes sociales.

Operador (Personal Administrativo): Usuario encargado de actualizar la información sobre procesos y requisitos de los diferentes departamentos.
